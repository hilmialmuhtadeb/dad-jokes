...
<div>
  ...
  <div class="mx-auto mb-12 w-4/5 bg-violet-50 rounded-xl shadow-xl text-center px-4 sm:px-8">
    ...
    <p class="mt-8 mb-16 font-serif md:text-xl">{{ joke }}</p>
    <button class="px-8 py-2 rounded-full bg-violet-700 text-violet-50 mb-12" @click="setCurrentJoke">Lagi Dong</button>
  </div>
</div>
</template>
